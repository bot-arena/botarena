  ...
  return (
    <div className="flex gap-2">
      ...
      <button
        type="button"
        onClick={handleCopy}
        className="px-4 py-2 bg-[var(--color-accent-primary)] text-[var(--color-bg-panel)] uppercase text-[10px] font-bold border border-[var(--color-border-strong)] hover:opacity-90 transition-opacity"
