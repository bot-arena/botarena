  ...
  export default class Generate extends Command {
    ...
    async run(): Promise<void> {
      ...
      try {
        ...
        if (!flags['dry-run']) {
          // TODO: Upload to Supabase in next plan
          this.log('🚀 Profile generation complete!');
          this.log('📤 Ready to upload to BotArena (next plan)');
        } else {
          this.log('🔍 Dry run complete - configuration validated');
        }
