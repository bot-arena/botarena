...
|---|-------------|------|--------|-----------|
| 005 | Make badges beautiful on bot detail view (skills, mcps, clis) | 2026-01-31 | 445b258 | [005-make-badges-beautiful-bot-detail-view](./quick/005-make-badges-beautiful-bot-detail-view/) |
| 004 | *(placeholder - not in table)* | - | - | - |
